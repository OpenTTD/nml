...
callbacks[0x00] = {
    ...
    "articulated_part": {
        ...
        "flag_bit": 4,
        "purchase": 1,
    },  # Don't add separate purchase CB here
    ...
    "tractive_effort_coefficient": {
        ...
        "num": 0x36,
        "var10": 0x1F,
        "purchase": "purchase_tractive_effort_coefficient",
    },
...
callbacks[0x09] = {
    ...
    "cargo_amount_accept": {
        ...
        "num": 0x2B,
        "flag_bit": 2,
    },  # Should work like the industry CB, i.e. call multiple times
    "cargo_type_accept": {
        "type": "cb",
        "num": 0x2C,
        "flag_bit": 3,
