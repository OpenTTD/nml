...
varact2_globalvars = {
    ...
    'openttd_version'      : {'var': 0x21, 'start':  0, 'size': 32},
    'openttd_major'        : {'var': 0x21, 'start': 28, 'size':  4},
    'openttd_minor'        : {'var': 0x21, 'start': 24, 'size':  4},
    'openttd_revision'     : {'var': 0x21, 'start': 20, 'size':  4},
    'openttd_build'        : {'var': 0x21, 'start':  0, 'size': 20},
