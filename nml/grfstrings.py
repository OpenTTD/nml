...
class StringCommand:
    ...
    def __getattribute__(self, name):
        if name == "argument_is_assigment":
            generic.print_dbg(
                0, 'Internal error: attribute "argument_is_assigment" has been renamed to "argument_is_assignment"'
            )
            name = "argument_is_assignment"
...
class NewGRFString:
    ...
    def __init__(self, string, lang, pos):
        ...
        while idx < len(string):
            ...
            if string[end] != "}":
                command.argument_is_assignment = string[end] == "="
                arg_start = end + 1
