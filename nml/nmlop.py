...
CMP_EQ      = Operator( True,     None, None,  True,   None, None, '==', operator.eq)
CMP_NEQ     = Operator( True,     None, None,  True,   None, None, '!=', operator.ne)
CMP_LE      = Operator( True,     None, None,  True,   None, None, '<=', operator.le)
CMP_GE      = Operator( True,     None, None,  True,   None, None, '>=', operator.ge)
CMP_LT      = Operator( True,     None, None,  True,   None, None,  '<', operator.lt)
CMP_GT      = Operator( True,     None, None,  True,   None, None,  '>', operator.gt)
...
VACT2_CMP   = Operator( True,     None,   18, False,   None, None, None, None)
